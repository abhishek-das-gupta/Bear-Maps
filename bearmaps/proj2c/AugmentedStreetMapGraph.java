...
public class AugmentedStreetMapGraph extends StreetMapGraph {
    ...
    public AugmentedStreetMapGraph(String dbPath) {
        ...
        for(Node node: nodes){
            if(node.name() != null){
                ...
                trie.add(cleanName);
                if(!nameNodeMap.containsKey(cleanName)){
                    nameNodeMap.put(cleanName, new LinkedList<>());
                }
                nameNodeMap.get(cleanName).add(node);
            }
    ...
    public List<String> getLocationsByPrefix(String prefix) {
        ...
        for (String name: cleanNames) {
            for (Node n: nameNodeMap.get(name)) {
    ...
    public List<Map<String, Object>> getLocations(String locationName) {
        ...
        if (nameNodeMap.containsKey(cleanName)) {
            for (Node n: nameNodeMap.get(cleanName)) {
